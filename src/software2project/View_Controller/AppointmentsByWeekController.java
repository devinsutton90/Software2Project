...
public class AppointmentsByWeekController implements Initializable {
    ...
    @FXML
    private TableView<Appointment> WeekAppointmentTableView;
    @FXML
    ...
    @FXML
    private Button WeekModifyBtn;
    @FXML
    private Button WeekDeleteBtn;
    ...
    private void MonthViewMenuItemSelect(ActionEvent event) throws Exception{
        Stage stage;        
        stage=(Stage) WeekAppointmentTableView.getScene().getWindow();
    ...
    @FXML
    private void ViewAllAppointmentsAction(ActionEvent event) throws Exception{
        Stage stage;        
        stage=(Stage) WeekAppointmentTableView.getScene().getWindow();
        FXMLLoader loader = new FXMLLoader();
    ...
    @FXML
    private void modifySelectedAppointment(ActionEvent event) throws Exception{
        if (WeekAppointmentTableView.getSelectionModel().getSelectedIndex() != -1) {
            user.setSelectedAppointment(WeekAppointmentTableView.getSelectionModel().getSelectedItem());
            Stage stage;
    ...
    public void setSoftware2Project(Software2Project software2Project) throws Exception{
        ...
        SQLExecute execute = new SQLExecute();
        execute.getUserWeekSchedule();
        WeekAppointmentTableView.setItems(user.getAppointmentList());
    }
}
